...
import { SobreComponent } from "./components.internal/sobre/sobre.component";
...
@Component({
    ...
    imports: [RegularHeaderComponent, RegularFooterComponent, SobreComponent, GrupoDeEstudoComponent, HistoricoComponent, ObjetivosEComposicaoComponent, DescritivoSobreLogoComponent]
})
