...
@Component({
    ...
    imports: [RegularSectionBoxComponent, RegularSectionBoxTitleComponent, RegularFlexBoxComponent, SmallSectionBoxComponent, RegularTextLinkComponent, RegularVerticalPaddingComponent, BorderTextLinkComponent, AnimatedSectionBoxComponent]
})
