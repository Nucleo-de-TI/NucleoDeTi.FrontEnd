...
import { PromisifyServiceUtil } from '../../../../../utils/promisify-service/promisify-service.util';
...
@Component({
  ...
  providers: [HttpClient, PartnersService, PromisifyServiceUtil],
  imports: [
    CommonModule,
...
export class ContatoComponent {
  constructor(
    ...
    private readonly promisifyServiceUtil: PromisifyServiceUtil
  ) {}
  ...
  private async sendEmail() {
    ...
    try {
      await this.promisifyServiceUtil.callService(() =>
        this.partnersService.sendEmail(
          fields.email.value,
